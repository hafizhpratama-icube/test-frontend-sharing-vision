            ...
            <div class="container-lg">
                <form action='{{url("/posts")}}' method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <button type="submit" name="status" class="mt-5 btn btn-primary ml-3" value="publish">Publish</button>
                        <button type="submit" name="status" class="btn ml-3 btn-outline-info" value="draft">Draft</button>
                    </div>
                </form>
